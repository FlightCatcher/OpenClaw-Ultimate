...
可选的[生活连接层](docs/09_LIFE_CONNECTORS.md)通过 Home Assistant 接入米家和
Matter 设备，并通过企业微信群机器人、QQ 开放平台官方机器人发送经确认的通知。
个人账号挂机、模拟点击和绕过平台登录不在支持范围内。
...
- 读取米家/Matter 设备状态，并在一次性确认后执行白名单家居控制或发送生活通知。
